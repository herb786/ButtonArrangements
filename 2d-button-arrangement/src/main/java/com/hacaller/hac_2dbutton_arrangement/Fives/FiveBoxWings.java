...
public class FiveBoxWings extends BaseRectShapeView {
    ...
    private void drawButtonA(Canvas canvas) {
        clearCoords();
        pathSrc = new Path();
        String srcString = "M 0,-4e-6 H 102.4 V 102.4 H 0 Z";
    ...
    private void drawButtonC(Canvas canvas) {
        clearCoords();
        pathSrc = new Path();
        String srcString = "M 204.8,153.60001 H 307.2 V 256.00001 H 204.8 Z";
        pathSrc = drawClosedPathWithSrc(pathSrc, 1f, srcString);
    ...
    private void drawButtonE(Canvas canvas) {
        clearCoords();
        pathSrc = new Path();
        String srcString = "M 409.60001,-4e-6 H 512.00001 V 102.4 H 409.60001 Z";
        pathSrc = drawClosedPathWithSrc(pathSrc, 1f, srcString);
